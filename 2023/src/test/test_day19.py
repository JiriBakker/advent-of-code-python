...
def test_day19a_example():
    assert 19114 == day19a(to_str_list(
...
def test_day19a_actual():
    assert 48652 == day19a(read_input(day = 19))

# def test_day19b_example():
#     assert 952408144115 == day19b(to_str_list(
#         """px{a<2006:qkq,m>2090:A,rfg}
# pv{a>1716:R,A}
# lnx{m>1548:A,A}
# rfg{s<537:gd,x>2440:R,A}
...
#     assert 45757884535661 == day19b(read_input(day = 19)) 